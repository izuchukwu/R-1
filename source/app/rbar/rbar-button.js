class Button {
    constructor(options) {
        ...
        this._icon.classList.add('rbar-button-icon')
    ...
    initAnimations() {
        this._button.addEventListener('mousedown', () => {
            this._circle.classList.add('rbar-button-circle-click')
        })
        ...
        this._button.addEventListener('mouseup', () => {
            ...
            this._circle.classList.remove('rbar-button-circle-click')
            this._circle.classList.remove('rbar-button-circle-release')
            this._circle.offsetWidth
            this._circle.classList.add('rbar-button-circle-release')
        })
    }
